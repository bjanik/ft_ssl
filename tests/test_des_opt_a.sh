...
echo ---------- TEST DES3-CBC ----------
./ft_ssl des3-cbc -i auteur -k 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -v 45DEFACB -a > 42
openssl des3 -in auteur -K 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -iv 45DEFACB -a |  tr -d '\n'  > 43
diff 42 43
echo ----------------------------------
./ft_ssl des3-cbc -i /bin/ls -k 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -v 45DEFACB -a > 42
openssl des3 -in /bin/ls -K 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -iv 45DEFACB -a | tr -d '\n' > 43
diff 42 43
echo ----------------------------------
./ft_ssl des3-cbc -i /bin/bash -k 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -v 45DEFACB -a > 42
openssl des3 -in /bin/bash -K 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -iv 45DEFACB -a | tr -d '\n' > 43
diff 42 43
echo ----------------------------------
./ft_ssl des3-cbc -i /bin/cat -k 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -v 45DEFACB -a > 42
openssl des3 -in /bin/cat -K 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -iv 45DEFACB -a | tr -d '\n' > 43
diff 42 43
echo ----------------------------------
./ft_ssl des3-cbc -i ft_ssl -k 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -v 45DEFACB -a > 42
openssl des3 -in ft_ssl -K 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -iv 45DEFACB -a | tr -d '\n' > 43
diff 42 43
echo ----------------------------------
./ft_ssl des3-cbc -i /usr/bin/openssl -k 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -v 45DEFACB -a > 42
openssl des3 -in /usr/bin/openssl -K 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -iv 45DEFACB -a | tr -d '\n' > 43
diff 42 43

echo ---------- TEST DES3-ECB ----------
./ft_ssl des3-ecb -i auteur -k 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -a > 42
openssl des-ede3 -in auteur -K 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -a |  tr -d '\n'  > 43
diff 42 43
echo ----------------------------------
./ft_ssl des3-ecb -i /bin/ls -k 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -a > 42
openssl des-ede3 -in /bin/ls -K 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -a | tr -d '\n' > 43
diff 42 43
echo ----------------------------------
./ft_ssl des3-ecb -i /bin/bash -k 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -a > 42
openssl des-ede3 -in /bin/bash -K 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -a | tr -d '\n' > 43
diff 42 43
echo ----------------------------------
./ft_ssl des3-ecb -i /bin/cat -k 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -a > 42
openssl des-ede3 -in /bin/cat -K 778855AAAAA874CDFEEE500EDAC068464696ADFFFCC00 -a | tr -d '\n' > 43
diff 42 43
echo ----------------------------------
./ft_ssl des3-ecb -i ft_ssl -k 778855AABBA874CDFEEE500EDAC068464677ADFFDCC00 -a > 42
